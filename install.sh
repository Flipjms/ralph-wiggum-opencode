...
# Usage: curl -fsSL https://raw.githubusercontent.com/Flipjms/ralph-wiggum-opencode/refs/heads/main/install.sh | bash

set -euo pipefail

REPO_RAW="https://raw.githubusercontent.com/Flipjms/ralph-wiggum-opencode/refs/heads/main"
